...
//                 {cartSuccessMessage && <p>{cartSuccessMessage}</p>}
...
//                 {/* Render DescriptionBox once here */}
...
//ok, so im facing an major issue like i want a description box that store description the code is working like that but its shows 2 description boxes the 1st box working fine but the second 1 is not working so, i did not understand where should i change. so please make both the box working correct or remove 1 i will provide you both  the code fix:
