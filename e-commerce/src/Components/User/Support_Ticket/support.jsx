...
// const SupportTicket = () => {
//   const [userId, setUserId] = useState(null); // Initially set to null, will get from local storage or context
//   const [subject, setSubject] = useState('');
//   const [details, setDetails] = useState('');
//   const [loading, setLoading] = useState(false);
//   const [supportTickets, setSupportTickets] = useState([]);
...
//   // Fetch User ID from localStorage or Context (Update as per your authentication flow)
//   useEffect(() => {
//     const fetchUserId = () => {
//       // Replace this with your logic to get the userId, for example from localStorage or context
//       const storedUserId = localStorage.getItem('userId'); // Example of getting from localStorage
//       if (storedUserId) {
...
//   // Fetch Support Tickets on page load or when userId changes
//   useEffect(() => {
//     if (userId) {
//       const fetchSupportTickets = async () => {
//         try {
