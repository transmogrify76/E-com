 ...
 import { faBoxOpen, faMoneyBillAlt, faUsers, faTruck, faChartBar } from '@fortawesome/free-solid-svg-icons';
 ...
 const SellerDashboard = () => {
    ...
    const handleAddProduct = () => {
        // Logic to add a product can be implemented here
        alert('Product added functionality can be implemented here.');
    };
