...
import './WholesaleUserLogin.css'; // Import the corresponding CSS file

const WholesaleUserLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            // Attempt login for wholesale user
    ...
    return (
        <div className="wholesale-login-container">
                           ...
                           <div className="card-body-login">
                               <form onSubmit={handleLogin}>
                                   ...
                                   <div className="forgot-password">
                                       <Link to="/wholesaleuser-forgetpassword">Forgot password? Click here</Link>
                                   </div>
                                   <div className="signup-link">
                                       <span>Don't have an account? </span>
                                       <Link to="/wholesaleuser-signup" className="signup">Signup</Link>
                                   </div>
                               </form>
                           </div>
                       </div>
...
export default WholesaleUserLogin;
